    ...
    return {
      ...
      dataimg: [
        ...
        // },
        {
          ...
          txt: "省网电力保供裕度系数",
          // name: ["省网电力保供裕度系数"],
          time: ['6:00', '10:00', '12:00', '14:00', '16:00', '20:00'],
          indicatorData: [
            { name: '省网电力保供裕度系数', },
            { name: '省网跨区消纳直流能力', },
            { name: '省网电量保供裕度系数', },
          ...
          type: 1,
          data: [
            [0.778392594, 0.716100098, 0.941528789],
            [0.780355935, 0.769857571, 1.008330278],
            [0.761555201, 0.761003666, 0.999829943],
            [0.738178435, 0.714304343, 0.999791597],
            [0.627902358, 0.566867842, 1.003720193],
            [0.312962519, 0.321235059, 1.662200367]
            //电力 6 10 12 14 16 20
        ...
        },
        {
          ...
          time: ['6:00', '10:00', '12:00', '14:00', '16:00', '20:00'],
          data: [
            [1.928554111, 2.570979678, 1.462710505, 1.027465918],
            [0.758587639, 0.672332311, 1.496391339, 1.49659182],
            [0.632430803, 0.638077197, 1.478748998, 1.47734563],
            [0.761389993, 0.71188223, 1.493985565, 1.281475541],
            [1.002610974, 1.330991417, 0.879711307, 0.837810746],
            [11.42748858, 12.78544325, 1.278267843, 1.297514034]
            //电力 6 10 12 14 16 20
